...
QtObject {
    ...
    readonly property var glyphMap: ({
            ...
            "􀊱": { sfName: "microphone.fill", usage: "privacy mic active" },
            "􀌟": { sfName: "camera.fill", usage: "privacy camera active" },
            "􁅀": { sfName: "inset.filled.rectangle.and.person.filled", usage: "privacy system audio / screen share" },
