...
window_rules:
  ...
  - commands: ["move --workspace 3"]
    match:
      - window_process: { regex: "brave|chrome|Arc" }
  # second monitor
  - commands: ["move --workspace 6"]
    match:
      - window_process: { regex: "Discord|ms-teams|Telegram" }
  - commands: ['ignore']
    match:
     # Ignores any Zebar windows.
      ...
      - window_process: { equals: 'zebar' }
        window_title: { equals: "Zebar - i3wm/i3wm" }
...
#   # Disables window management and all other keybindings until alt+shift+p
#   # is pressed again.
#   - commands: ['shell-exec taskbartoggle']
...
#     bindings: ['alt+enter']
#   - commands: ['shell-exec wt wsl -d NixOS']
